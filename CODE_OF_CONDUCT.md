...
When an incident does occur, it is important to report it promptly. To report a possible violation, please open an issue in this repository with the label `code-of-conduct`.
